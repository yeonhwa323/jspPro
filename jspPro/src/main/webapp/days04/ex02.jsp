...
<div>
  <xmp class="code">
     [jsp 웹 어플리케이션 4가지 영역(scope) - 저장 목적]   
     ( 범위 : 좁음 -> 넓어짐 )      
     1. 하나의 페이지에서 사용할 수 있는 영역 : page scope
     								pageContext 기본객체
     2. 하나의 요청에 사용할 수 있는 영역 : request scope
     								request  기본객체.
     		예) request.setAttribute("list", list);
     		예) request.setAttribute("dto", dto);
     3. 하나의 웹 브라우저에서 사용되는 영역 : session scope   예)사물함
     								session 기본 객체
     4. 하나의 웹 애플리케이션(웹 사이트)에서 사용되는 영역 : application scope
     								application 기본 객체
