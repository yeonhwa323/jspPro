...
<div>
  <xmp class="code">
    [파일 업로드 방법]
    1. 개발자가 직접 구현하는 방법 - 잘 사용 X
    	request.getInputStream();
    2. 외부 라이브러리 사용 ***
    	ㄱ. http:www.servlet.com
    ...
    3. 서블릿 3.0 또는 3.1 에서 제공하는 라이브러리.
      1) HttpServletReqeust request 의 [getPart()]를 이용해서 
      ...
      2) 서블릿이 multipart 데이터를 처리할 수 있도록 세팅..
      	- web.xml 설정
      	- @MultipartConfig 어노테이션을 사용해서 설정. 
      	
      	실습)
      	 1) 서블릿 days09.UploadServlet.java - 파일 처리를 위한 객체
      	 2) web.xml 설정
      	 3) ex03.jsp
  </xmp>  
</div>
