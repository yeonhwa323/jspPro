...
<style>[_nghost-sin-c86]{color:#303033}.discount.sell[_nghost-sin-c86]{display:block;font-weight:400;color:#d4d4d4}.discount.sale[_nghost-sin-c86]{display:block;color:#ff4800}</style>
