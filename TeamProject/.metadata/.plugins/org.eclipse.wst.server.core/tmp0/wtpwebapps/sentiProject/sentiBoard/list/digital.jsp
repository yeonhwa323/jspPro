...
<body>
	<div id="wrap">
		<div id="best-left">
			<button></button>
			<div>
				<h2 class="best_title_left">컴퓨터,디지털</h2>
				<ul class="left-menu">
					 	<%
    ...
    <!-- 각 도메인의 url도 db에 있어야 할거 같음.  -->
		...
		<div id="best-right">
			<!-- <h2 class="best_title_right" >디지털</h2> -->
			<div class="widget">
       ...
       success: function(data){
           ...
           $(data.small_ctgr).each(function(index, element){
               ...
               $(".widget-top-btn-box").append(`	
            		   ...
            		   <button class="wm-top-btn" value="\${element.small_ctgr_id}">
  						...
  						<div class="gg">
  							<a class="hh" href="#">\${element.brand_name}</a> <a
  								...
  								<div class="j">
  									...
  									<div class="01">
  										<span class="kkk"></span> <strong class="qqq">\${Number(element.pd_price).toLocaleString()}</strong>
  									</div>
  									<ul class="eee">
  										<li class="yyy"></li>
  										<li></li>
  							...
  							<div class="ppp">
  								...
  								<path
  									...
  									<div class="review-count">평점 필요</div>
  								</a>
  							</div>
  						</div>
  					</div>
...
<script>
$(document).on('click', '.wm-top-btn', function(){
