...
ResultSet rs = null;
String sql = " SELECT medium_ctgr_id, medium_ctgr_name, large_ctgr_id " + " FROM medium_ctgr"
			...
			<div>
				...
				<ul class="left-menu">
					...
					<li value="<%=mcvo.getMedium_ctgr_id()%>"
						class="medium_ctgr_id111">
						<!-- value값은 밑에서 ajax 처리 할 때 사용하기 위해 지정해준다.  --> <a href="#"
						class="medium-ctgr"
		...
		<div id="best-right">
			<div class="widget">
				...
				<div class="controlgroup">
					<!-- 정렬 기능을 추가한 sql문이 필요 , 따로 json파일을 만들어야 할지 고민중...  -->
						...
						<div class="cc">
							...
							<div class="gg">
								<a class="hh" href="#">${list.brandName}</a> <a
									...
									<div class="j">
										<h5 class="jj">${list.pdName}(10Color)</h5>
