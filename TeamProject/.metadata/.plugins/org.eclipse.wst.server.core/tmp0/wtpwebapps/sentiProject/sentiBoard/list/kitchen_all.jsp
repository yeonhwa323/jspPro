                   ...
                   $(".photo_list").append(`	
                  	<li class="photo1">
       					<div class="cc">
       						...
       						<a href="/sentiBodard/view/view.do?pd_id=\${element.pd_id} ">
       							<div class="dd">
       								<img alt=""
		           ...
		           success: function(data){           	 
		               ...
		               $(data.Product_small).each(function(index, element){	                     
		                   $(".photo_list").append(`	
		                  	<li class="photo1">
		       					<div class="cc">
		       						<a href="/sentiBoard/view/viewDeatail.do?pd_id=\${element.pdId}">
		       							<div class="dd">
		       								<img alt=""
...
<script>
//모든 상품 리스트 아이템을 선택합니다.
const productItems = document.querySelectorAll('#photo_list li');

// 각 아이템에 클릭 이벤트 리스너를 추가합니다.
productItems.forEach(item => {
  item.addEventListener('click', (event) => {
    // 클릭한 아이템의 data-id 속성 값을 가져옵니다.
    const productId = event.currentTarget.getAttribute('pdId');
    
    // 상세 페이지 URL을 생성합니다.
    const detailPageUrl = `/sentiBoard/view/viewDeatail.do?pd_id=${pdId}`;
    
    // 상세 페이지로 이동합니다.
    window.location.href = "/sentiBoard/view/viewDeatail.jsp";
  });
});
