 ...
 * Generated at: 2024-04-29 08:15:46 UTC
...
public final class ex07_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  	js ajax     ex07_dept.json     \r\n");
      out.write("  	json -> js Object 변환\r\n");
      out.write("  	출력을 원하는 태그로 만들어서 출력 ol/li, table, select 등           \r\n");
      out.write("  </xmp> \r\n");
      out.write("  \r\n");
      out.write("  <button type=\"button\">ex07_dept.json -> ajax -> 태그 출력</button>\r\n");
      out.write("  \r\n");
      out.write("  <br>\r\n");
      out.write("  <br>\r\n");
      out.write("  \r\n");
      out.write("  <d id=\"demo\"></d> \r\n");
      out.write("  \r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("	$(\"button\").on(\"click\", function(){\r\n");
      out.write("		sendRequest(\"ex07_dept.json\", null, callback, \"GET\");\r\n");
      out.write("	\r\n");
      out.write("	function callback(){\r\n");
      out.write("		if(httpRequest.readyState == 4 ){ // 서버 요청 완료\r\n");
      out.write("			if(httpRequest.status == 200) { // 응답성공\r\n");
      out.write("				\r\n");
      out.write("				let deptJson = httpRequest.responseText;\r\n");
      out.write("						\r\n");
      out.write("				//$(\"#demo\").html(deptJson);\r\n");
      out.write("				\r\n");
      out.write("				// json -> js Object 변환\r\n");
      out.write("				let deptObj = JSON.parse(deptJson);\r\n");
      out.write("				//$(\"#demo\").html(deptObj.departments.length);\r\n");
      out.write("				\r\n");
      out.write("				const deptArray = [];\r\n");
      out.write("				for (let dept of deptObj.departments) {\r\n");
      out.write("					//console.log(dept.deptno + \"/\" + dept.dname +\"/\" + dept.loc );\r\n");
      out.write("					$(\"#demo\").append(`<li>${dept.dname}</li>`);\r\n");
      out.write("					deptArray.push(dept);\r\n");
      out.write("				}\r\n");
      out.write("				// deptArray 사용해서 처리..\r\n");
      out.write("				\r\n");
      out.write("			} else {\r\n");
